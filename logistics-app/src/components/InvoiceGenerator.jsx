  ...
  const fetchTotalExpense = async () => {
    try {
      ...
      const res = await axios.get(
        `http://localhost:5000/api/trips/total-expense`,
        {
          params: {
